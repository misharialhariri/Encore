...
type Props = NativeStackScreenProps<SharedListingRoutes & { MyOrders: undefined }, "MyOrders">;
...
export function MyOrdersScreen({ navigation }: Props) {
  ...
  return (
    <ScreenContainer scroll={false}>
      <Text style={{ fontSize: 22, fontWeight: "700", color: colors.ink, marginTop: spacing.sm }}>{t("orders.myOrdersTitle")}</Text>
